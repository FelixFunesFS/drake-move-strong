  ...
  return (
    <>
      <SEO
        ...
        description="Book group fitness and workout classes in Charleston. Morning & evening sessions: Foundation Flow, Functional Strength, KB Strong — Strength & Mobility. Small groups, expert coaching."
