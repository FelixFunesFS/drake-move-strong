        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection animation="scaleIn" delay={0.2} className="relative overflow-hidden rounded-lg">
              <OptimizedImage src={outdoorTraining} alt="Outdoor functional training with kettlebells" className="shadow-2xl w-full" aspectRatio="square" transparent={true} hideLoadingPlaceholder={true} sizes="(max-width: 768px) 100vw, 580px" />
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[{
              ...
              description: "Assessments every 4–8 weeks so you can see your progress."
                ...
                <div className="bg-drake-dark/80 border border-white/10 p-8 rounded-xl h-full hover:bg-drake-dark/90 transition-colors backdrop-blur-sm">
            ...
            <AnimatedSection animation="fadeInUp" delay={0.4} className="md:col-span-2">
              <div className="bg-drake-dark/80 border border-white/10 p-8 rounded-xl hover:bg-drake-dark/90 transition-colors backdrop-blur-sm">
