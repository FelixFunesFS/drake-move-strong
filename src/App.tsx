...
const AdminSocialGraphics = lazy(() => import("./pages/admin/SocialGraphics"));
...
const STANDALONE_ROUTES = ['/new-year', '/intro', '/reset', '/ruckathon', '/auth'];
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        {!hideNavFooter && !['/','/about','/schedule','/try-free-charleston','/intro'].includes(location.pathname) && <TodayClassesBanner />}
