            ...
            >
              ...
              {secondaryCTA && (
                secondaryCTA.link.startsWith('http') ? (
                  <Button asChild size="lg" variant="outline" className="bg-white/10 backdrop-blur-md border-2 border-white text-white hover:bg-white hover:text-drake-dark font-semibold text-sm sm:text-base md:text-base px-6 sm:px-8 md:px-8 py-4 sm:py-5 md:py-4 h-auto min-h-[52px] md:min-h-[40px] w-full sm:w-auto">
