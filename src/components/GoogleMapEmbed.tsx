...
export function GoogleMapEmbed({ height = "400px", className = "" }: GoogleMapEmbedProps) {
  return (
    <div className={`rounded-2xl overflow-hidden shadow-lg ${className}`} style={{ minHeight: height }}>
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3352.8047899999997!2d-79.9876!3d32.7876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88fe7a1e4c4c4c4d%3A0x1234567890abcdef!2sDrake%20Fitness!5e0!3m2!1sen!2sus!4v1704672000000!5m2!1sen!2sus"
        width="100%"
        height="100%"
