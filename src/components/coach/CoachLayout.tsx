...
import { useAuth } from '@/contexts/LazyAuthContext';
...
const navItems = [
  ...
  { href: '/coach/members', label: 'My Members', icon: Users },
  { href: '/coach/classes', label: 'My Classes', icon: Calendar },
  { href: '/coach/templates', label: 'Workout Templates', icon: ClipboardList },
  { href: '/coach/progress', label: 'Member Progress', icon: TrendingUp },
];
    ...
    <div className="min-h-screen bg-muted">
      ...
      <header className="md:hidden bg-primary text-primary-foreground sticky top-0 z-50">
        <div className="flex items-center justify-between px-4 py-3">
          <Link to="/coach/dashboard" className="font-hero text-lg uppercase">
            Coach Portal
          </Link>
          <Button
            variant="ghost"
      ...
      <div className="flex">
        ...
        <aside className="hidden md:flex flex-col w-64 min-h-screen bg-primary text-primary-foreground fixed left-0 top-0">
          <div className="p-6 border-b border-primary-foreground/10">
            <Link to="/coach/dashboard" className="font-hero text-xl uppercase">
              Coach Portal
            </Link>
